...
{{<pre go>}}if w.AddPressure(info, m, track, info.Config.Spam.BasePressure) {
	return true
}
...
{{<pre go>}}timestamp := bot.GetTimestamp(m)
...
{{<img src="/img/pressure.png" alt="Pressure Graph" width="481">}}
